...
for (const marker of [
  ...
  'id="fluttering_ribbon"', '/js/click-pulse.js',
  'pluginsSrc/butterfly-extsrc/dist/activate-power-mode.min.js',
  'POWERMODE.colorful = false', 'POWERMODE.shake = false',
...
assert(!home.includes('fireworks.min.js'), 'Fireworks should be replaced by the click reticle');
